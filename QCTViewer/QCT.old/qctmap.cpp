...
void QctMap::read()
{
    ...
    int* paletteData = m_palette.getPaletteData();
 ...
 */
int* QctMap::readTile(const int tileX, const int tileY) const
{
    return m_tileMgr.readTile(tileX, tileY, m_file, m_fileSize);
}
